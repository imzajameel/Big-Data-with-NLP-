# -*- coding: utf-8 -*-
"""Data Exploration & Moodelling.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/12in_n4nJx594avXgcYeN0h2PKtWIa3vB
...
data = pd.read_csv("/content/amazon_alexa (2).tsv", delimiter = '\t', quoting = 3)
...
"""Observation :  There is one record with no 'verified_reviews' (null value)"""
...
"""Observation : The 'length' column is new generated column - stores the length of 'verified_reviews' for that record. Let's check for some sample records"""
...
"""Observation :  We can see that the length of review is the same as the value in the length column for that record
